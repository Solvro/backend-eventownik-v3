...
export enum ParticipantsExportFormat {
  xlsx = "xlsx",
}
...
export class ExportParticipantsQueryDto {
  @ApiPropertyOptional({
    ...
    enum: ParticipantsExportFormat,
    enumName: "ParticipantsExportFormat",
    default: ParticipantsExportFormat.xlsx,
  })
  @IsOptional()
  @IsEnum(ParticipantsExportFormat)
  readonly format?: ParticipantsExportFormat = ParticipantsExportFormat.xlsx;
